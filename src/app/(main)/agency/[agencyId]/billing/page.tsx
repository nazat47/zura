...
import { addOnProducts, pricingCards } from "@/lib/contants";
    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-8">
        <PricingCard
          ...
          highlightDescription="Want to modify your plan? you can do this here. If you have further question contact support@zura.com"
      ...
      <h1 className="text-2xl p-4">Payment History</h1>
