...
const SubAccountId = async ({ params, searchParams }: Props) => {
  let currency = "USD";
  let sessions;
  ...
  if (subaccountDetails.connectAccountId) {
    ...
    net = +totalClosedSessions.reduce(
      (acc, session) => acc + (session.amount_subtotal || 0),
      0
    );
        ...
        <div className="flex flex-col gap-4 pb-6">
          ...
          <div className="flex gap-4 flex-col xl:flex-row">
            <Card className="relative">
              ...
              <CardContent className="text-sm text-muted-foreground flex flex-col gpa-12 justify-between">
