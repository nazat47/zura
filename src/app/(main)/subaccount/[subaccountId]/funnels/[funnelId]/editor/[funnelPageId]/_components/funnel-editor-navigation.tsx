...
const FunnelEditorNavigation = ({
  ...
  const handleOnSave = async () => {
    ...
    try {
      ...
      toast({
        title: "Oopse!",
        description: "Could not save contents.",
      });
    }
  };
  ...
  return (
    <TooltipProvider>
      <nav
        className={clsx(
          "border-b-[1px] flex items-center justify-between p-6 gap-2 translate-all",
      ...
      >
        ...
        <aside className="flex items-center gap-2">
          ...
          <div className="flex flex-cel items-center mr-4">
