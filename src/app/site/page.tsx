...
export default async function Home() {
  const prices = await stripe.prices.list({
    product: process.env.NEXT_ZURA_PRODUCT_ID,
    active: true,
  });

  return (
    <>
      <section className="h-full w-full sm:pt-36 relative flex items-center justify-center flex-col">
        ...
        <div className="flex justify-center items-center relative md:mt-[-40px]">
          ...
          />
          <div className="absolute bottom-0 right-0 left-0 top-[50%] bg-gradient-to-t dark:from-background z-10"></div>
        </div>
      </section>
      <section className="flex justify-center items-center flex-col gap-4 sm:mt-40">
